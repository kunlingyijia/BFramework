...
///请求验证码
NSString * const  Request_VerifyCode = @"/VerifyCode/verifyCode";
///注册
...
//第三方登录绑定手机号
NSString * const  Request_ThirdLoginBindMobile =@"/Login/thirdLogin";
///找回密码
...
///实名认证查询
NSString * const  Request_CertifyInfo = @"/User/certifyInfo";
///消息列表
