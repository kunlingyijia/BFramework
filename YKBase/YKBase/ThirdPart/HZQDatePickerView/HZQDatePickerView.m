...
- (void)awakeFromNib
{
    ...
    [self.sureBtn setTitleColor:[UIColor colorwithHexString:kBlueColor] forState:0];
    self.sureBtn.layer.borderColor = [[UIColor colorwithHexString:kBlueColor] CGColor];
