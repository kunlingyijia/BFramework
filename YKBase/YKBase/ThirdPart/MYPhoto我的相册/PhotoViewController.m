...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    for (int i = 0; i < self.urlArray.count; i ++) {
        ...
        [imgView sd_setImageWithURL:[self.urlArray objectAtIndex:i] placeholderImage:nil options:SDWebImageProgressiveDownload progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
